...
def main(argv=None):
    ...
    hardware=check_gpu(); api=HfApi(); a.output_root.mkdir(parents=True,exist_ok=True)
    ...
    for model in a.models:
        ...
        cache=a.output_root/"cache"/"native"
        def encode(texts): return cached_embeddings(cache,identity,texts,encoder.encode)[0]
